...
void buscarTesoro(vector<vector<char>> T) {
    int r, c; // Coordenadas del agente
    cout << "\nDigite las coordenadas del agente (r c): ";
    cin >> r >> c;

    ResultadoDFS respuesta_algoritmo = dfs(T, r, c);

    // IMPRIMIR EL RESULTADO DE LA BUSQUEDA
    switch (respuesta_algoritmo) {
    case ResultadoDFS::FueraDeRango:
        cout << "\n\033[31mTen cuidado, la posicion inicial esta fuera del rango del mapa.\n\033[0m";
        break;
    case ResultadoDFS::EnObstaculo:
        cout << "\n\033[31mQue mal, La posicion inicial es un obstaculo.\n\033[0m";
        break;
    case ResultadoDFS::SinCamino:
        cout << "\n\033[31mLo lamentamos, no se puede llegar a un tesoro desde la posicion inicial.\n\033[0m";
        break;
    case ResultadoDFS::EnTesoro:
        cout << "\n\033[32mFelicidades, la posicion inicial es EL TESORO.\n\033[0m";
        break;
    case ResultadoDFS::CaminoHaciaTesoro:
        cout << "\n\033[32mFelicidades, existe un camino hacia el tesoro desde la posicion inicial.\n\033[0m";
        break;
    default:
        cout << "\n\033[31mResultado desconocido.\n\033[0m";
    }
}
